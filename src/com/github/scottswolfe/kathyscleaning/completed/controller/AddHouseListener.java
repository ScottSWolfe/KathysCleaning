...
//  CONSTRUCTOR
    ...
    public AddHouseListener(DayPanel day_panel, HousePanel house_panel, WorkerList dwd, JFrame frame, TabbedPane tp) {
...
//  LISTENER
    ...
    public void actionPerformed(ActionEvent e){
        ...
        // creating new panel
        new_house_panel[index + 1] = HousePanel.from(frame, tp, day_panel);

        // temporary hack
        WorkerList workers = day_panel.header_panel.getWorkers();
        new_house_panel[index + 1].setWorkerList(workers);
