...
public class EditCovenantWorkersPanel extends JPanel {
	...
	int rows = NW_CovenantPanel.WORKER_SELECT_ROW_COUNT;
	int columns = NW_CovenantPanel.WORKER_SELECT_COLUMN_COUNT;
    ...
    public EditCovenantWorkersPanel(NW_CovenantPanel cov_panel, JFrame frame, WorkerList workers, WorkerSelectPanel worker_panel) {
