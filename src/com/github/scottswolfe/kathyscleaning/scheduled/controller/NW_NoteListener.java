...
public class NW_NoteListener implements ActionListener {
	...
	// CONSTRUCTOR
	public NW_NoteListener ( NW_DayPanel day_panel, WorkerList dwd, NoteData note_data, JFrame container_frame) {
	...
	public void actionPerformed ( ActionEvent e ) {
		...
		NW_NotePanel np = new NW_NotePanel(frame, day_panel, dwd, selected_workers, note_data, this);
