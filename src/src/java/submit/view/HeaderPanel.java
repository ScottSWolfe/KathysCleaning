...
import src.java.general.controller.EditDefaultWorkersListener;
...
import src.java.submit.controller.CopyWorkersListener;
import src.java.submit.controller.NeitherRadioListener;
import src.java.submit.controller.SubmitWeekListener;
import src.java.submit.controller.WeekRadioListener;
import src.java.submit.model.DayData;
import src.java.submit.model.HeaderData;
...
// METHODS
	...
	private JPanel submitWeekPanel() {
		...
		submit_week.setFont( submit_week.getFont().deriveFont( DayPanel.FONT_SIZE ) );
		...
		submit_week.setBackground( DayPanel.MAIN_COLOR );
		submit_week.setForeground( DayPanel.FOREGROUND_COLOR );
